...
type
  ...
  public
    ...
    function GetReaderHost(const nID: string): PReaderHost;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if Assigned(nNode.NodeByName('mutextunnel')) then
          begin
            FMutexTunnel := nNode.NodeByName('mutextunnel').ValueAsString;
          end;
          FEEnable := False;
          FFun := rfSite;
